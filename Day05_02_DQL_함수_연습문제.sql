...
SELECT EMPLOYEE_ID, FIRST_NAME, LAST_NAME, EMAIL, PHONE_NUMBER, HIRE_DATE, JOB_ID, SALARY, COMMISSION_PCT, MANAGER_ID, DEPARTMENT_ID
  ...
  SELECT EMPLOYEE_ID, FIRST_NAME, LAST_NAME, EMAIL, PHONE_NUMBER, HIRE_DATE, JOB_ID, SALARY, COMMISSION_PCT, MANAGER_ID, DEPARTMENT_ID,
            CASE WHEN SUBSTR(PHONE_NUMBER, 1, 3) = '011' THEN 'MOBILE'
              ...
              WHEN SUBSTR(PHONE_NUMBER, 1, 3) = '650' THEN 'NORTH' END
  FROM EMPLOYEES;
...
SELECT EMPLOYEE_ID, FIRST_NAME, LAST_NAME, EMAIL, PHONE_NUMBER, HIRE_DATE, JOB_ID, SALARY, COMMISSION_PCT, MANAGER_ID, DEPARTMENT_ID
  ...
  SELECT FIRST_NAME, LAST_NAME, MONTHS_BETWEEN(SYSDATE, HIRE_DATE), CASE WHEN MONTHS_BETWEEN(SYSDATE, HIRE_DATE) >= 240 THEN '정산대상' END AS 정산유무
      FROM EMPLOYEES;
