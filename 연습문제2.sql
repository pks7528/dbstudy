...
-- 3. 1000부터 1씩 증가하는 값을 생성하는 CUSTOMER_SEQ 시퀀스를 생성한 뒤, CUSTOMER_SEQ를 이용하여 INSERT를 수행하시오.     -------------??????? CUSTOMER 어쩌고 이름 어디서 확인??
/*
회원번호 고객명   주소      전화
...
CREATE SEQUENCE ORDER_SEQ
    INCREMENT BY 1;
INSERT INTO ORDER_TBL(ORDER_ID, CUSTOMER_ID, BOOK_ID, AMOUNT, ORDER_DATE) VALUES (TO_CHAR(SYSDATE, 'YY/MM/DD') || - ORDER_SEQ.NEXTVAL, 1000, 1, 1, '20/07/01');
INSERT INTO ORDER_TBL(ORDER_ID, CUSTOMER_ID, BOOK_ID, AMOUNT, ORDER_DATE) VALUES (TO_CHAR(SYSDATE, 'YY/MM/DD') || - ORDER_SEQ.NEXTVAL, 1000, 3, 2, '20/07/03');
INSERT INTO ORDER_TBL(ORDER_ID, CUSTOMER_ID, BOOK_ID, AMOUNT, ORDER_DATE) VALUES (TO_CHAR(SYSDATE, 'YY/MM/DD') || - ORDER_SEQ.NEXTVAL, 1001, 5, 1, '20/07/03');
INSERT INTO ORDER_TBL(ORDER_ID, CUSTOMER_ID, BOOK_ID, AMOUNT, ORDER_DATE) VALUES (TO_CHAR(SYSDATE, 'YY/MM/DD') || - ORDER_SEQ.NEXTVAL, 1002, 6, 2, '20/07/04');
INSERT INTO ORDER_TBL(ORDER_ID, CUSTOMER_ID, BOOK_ID, AMOUNT, ORDER_DATE) VALUES (TO_CHAR(SYSDATE, 'YY/MM/DD') || - ORDER_SEQ.NEXTVAL, 1003, 7, 3, '20/07/05');
INSERT INTO ORDER_TBL(ORDER_ID, CUSTOMER_ID, BOOK_ID, AMOUNT, ORDER_DATE) VALUES (TO_CHAR(SYSDATE, 'YY/MM/DD') || - ORDER_SEQ.NEXTVAL, 1000, 2, 5, '20/07/07');
INSERT INTO ORDER_TBL(ORDER_ID, CUSTOMER_ID, BOOK_ID, AMOUNT, ORDER_DATE) VALUES (TO_CHAR(SYSDATE, 'YY/MM/DD') || - ORDER_SEQ.NEXTVAL, 1003, 8, 2, '20/07/07');
INSERT INTO ORDER_TBL(ORDER_ID, CUSTOMER_ID, BOOK_ID, AMOUNT, ORDER_DATE) VALUES (TO_CHAR(SYSDATE, 'YY/MM/DD') || - ORDER_SEQ.NEXTVAL, 1002, 10, 2, '20/07/08');
INSERT INTO ORDER_TBL(ORDER_ID, CUSTOMER_ID, BOOK_ID, AMOUNT, ORDER_DATE) VALUES (TO_CHAR(SYSDATE, 'YY/MM/DD') || - ORDER_SEQ.NEXTVAL, 1001, 10, 1, '20/07/09');
INSERT INTO ORDER_TBL(ORDER_ID, CUSTOMER_ID, BOOK_ID, AMOUNT, ORDER_DATE) VALUES (TO_CHAR(SYSDATE, 'YY/MM/DD') || - ORDER_SEQ.NEXTVAL, 1002, 6, 4, '20/07/10');
COMMIT;
