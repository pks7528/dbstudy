...
*/
SELECT STUDNO, SNAME, USERID, GRADE, IDNUM, TO_CHAR(BIRTHDATE, 'YYYY-MM-DD') AS 생일, TEL, HEIGHT, WEIGHT, DEPTNO
  FROM STUDENT;
...
*/
SELECT PROFNO, PNAME, USERID, POSITION, SAL, HIREDATE, COMM, FLOOR(SYSDATE-HIREDATE) AS 근무한일수
  FROM PROFESSOR;
...
*/
SELECT S.SNAME AS 학생명, D.DNAME AS 학과명, P.PNAME AS 담당교수명
...
SELECT D.DNAME AS 학과, COUNT(S.DEPTNO) AS 학생수
