...
-- 동리한 부서에서 근무하는 사원들을 조인하기 위해서 DEPARTMENT_ID로 조인 조건을 생성

-- 사원(나)        사원(남)
-- EMPLOYEE ME     EMPLOYEES YOU
...
-- 1) 표준 문법 -- 테이블 -EMPLOYEES - MODEL에서 확인

SELECT E.EMPLOYEE_ID, E.FIRST_NAME, D.DEPARTMENT_NAME
  FROM DEPARTMENTS D INNER JOIN EMPLOYEES E
    ON D.DEPARTMENT_ID = E.DEPARTMENT_ID
 WHERE D.LOCATION_ID = 1700; 
 -- 오라클은 숫자 문자 연산하면 숫자로 바꿈
...
-- 4. 부서별 DEPARTMENT NAME과 사원 수와 평균 연봉을 조회하시오.
