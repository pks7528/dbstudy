...
CREATE TABLE CUSTOMER_TBL(
    ...
    AGE         NUMBER             CHECK(0<= AGE AND AGE<=100), --CHECK(AGE BETWEEN 0 AND 100)
...
/*
    ...
    4. 칼럼 이름   : ALTER TABLE 테이블명 RENAME COLOMN 기존칼럼명 TO 신규칼럼명
...
-- 7. CUSTOMER_TBL에 NO 칼럼의 이름을 CUST_NO로 변경하시오.
ALTER TABLE CUSTOMER_TBL
...
/*
생성할때 안적으면 NULL
수정할때는 이전 제약 조건을 그대로 쓰겠다(NOT NULL일 수도 있음)....
그래서 반드시 제약조건을 적어줘야함
*/