...
-- 9. EMPLOYEES 테이블을 높은 SALARY를 받는 사원순(내림차순:Descending Sort)으로 조회하기
SELECT EMPLOYEE_ID, FIRST_NAME, LAST_NAME, SALARY
  FROM EMPLOYEES
 ORDER BY SALARY DESC;  -- DESC는 생략이 불가능하다.
 
-- 10. EMPLOYEE 테이블의 사원들을 DEPARTMENT_ID 순으로 조회하고 동일한 DEPARTMNET_ID를 가진 사원들은 높은 SALARY 순으로 조회하시오.
SELECT EMPLOYEE_ID, FIRST_NAME, LAST_NAME, DEPARTMENT_ID, SALARY
  FROM EMPLOYEES
 ORDER BY DEPARTMENT_ID, SALARY DESC;   -- DEPARTMENT_ID는 ASC 생략
